...
\newcommand{\VERSUCHSDATUM}{\DTMdisplaydate{2026}{3}{11}{-1}}
...
\newcommand{\BETREUER}{Leonie Dossmann}
\newcommand{\GRUPPENNR}{23}

\newcommand{\VERSUCHSNR}{}
\newcommand{\VERSUCHSNAME}{DNA II}
...
For the agarose gel electrophoresis of , 2.5 $\upmu$L of the DNA marker (Gene Ruler, Fermentas) were loaded instead of 5 $\upmu$L.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{AGE_DNA2.png}
    \caption{Agarose gel electrophoresis of the restriction digestion of plasmid DNA with EcoRI-HF, DpnI and DpnII.}
    \label{fig:gel}
\end{figure}
